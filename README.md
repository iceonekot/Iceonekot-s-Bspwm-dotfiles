...
mpv calcurse cmus neovim flameshot thunar thunderbird zoxide pass lf pywal setxkbmap Vs code (or Vs Codium, it's better) starship (for shell, bash) color scripts - https://gitlab.com/dwt1/shell-color-scripts
